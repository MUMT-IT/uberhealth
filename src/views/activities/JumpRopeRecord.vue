    ...
    <ion-content>
      <ion-grid>
        ...
        <ion-row>
          <ion-col>
            <ion-list>
              <ion-item detail v-for="record in jumpropesort.slice(0,7)"
...
export default defineComponent({
  ...
  updated() {
    this.jumpropesort = this.JumpRopeRecords
    this.jumpropesort.sort((a,b)=> b.startDateTime-a.startDateTime)
  }
})
</script>
