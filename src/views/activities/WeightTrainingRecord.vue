    ...
    <ion-content>
      <ion-grid>
        ...
        <ion-row>
          <ion-col>
            <ion-list>
              <ion-item detail v-for="record in weightsort.slice(0,7)"
...
export default defineComponent({
  ...
  updated(){
    this.weightsort = this.WeightTrainingRecords
    this.weightsort.sort((a,b)=> b.startDateTime-a.startDateTime)
  }
})
</script>
